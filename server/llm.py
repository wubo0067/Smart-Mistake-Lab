...
MATH_KNOWLEDGE_POINTS = [
    ...
    "阿基米德折弦定理：上有两条首尾相连、长度不相等的弦 AB、BC（组成一条折弦 A-B-C）。设 M 是弧 ABC（即含 B 的那段弧 AC）的中点。从 M 向较长的一段弦（设 BC > AB）作垂线，垂足为 F，那么 F 恰好是这条折弦的中点，即AB + BF = FC",
    "西姆松定理： 过三角形外接圆上异于三角形顶点的任意一点， 作三边或其延长线上的垂线， 则三垂足共线， 此线常称为西姆松线."
    # ==========================================
    # 五、动点、最值与几何变换
    # ==========================================
    "瓜豆原理动点轨迹为直线",
